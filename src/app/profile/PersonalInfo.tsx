...
export default function PersonalInfo({ profileData, setProfileData }) {
    ...
    return <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200/80 dark:border-zinc-800 p-6 shadow-2xs space-y-6">
        ...
        <UpdateProfile profileData={profileData} setProfileData={setProfileData} isEditProfileOpen={isEditProfileOpen} setIsEditProfileOpen={setIsEditProfileOpen} />

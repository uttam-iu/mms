...
export const ExtraExpenseTable = ({
    ...
    onAddNew: () => void;
    onUpdate: (item: ExtraExpense) => void;
    onDelete: (item: ExtraExpense) => void;
    isLoading: boolean;
}) => {
    return (
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200/80 dark:border-zinc-800 shadow-2xs overflow-hidden">
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                    ...
                    {monthwiseFixedCostData?.length > 0 && <tfoot className="bg-zinc-100 dark:bg-zinc-800 font-bold border-t-2 border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100">
                        <tr>
